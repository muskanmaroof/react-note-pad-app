              ...
              filteredPastes.map((paste) => (
                ...
                >
                  ...
                  <div className="w-[50%] flex flex-col space-y-3">
                    ...
                    <p className="text-sm font-normal line-clamp-3 max-w-[80%] text-[#fff]">
                      {paste?.content}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col gap-y-4 sm:items-end">
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                      <button
                        className="p-2 rounded-[0.2rem] bg-[#B57EDC] border border-[#c7c7c7]  hover:bg-transparent group hover:border-blue-500"
                      ...
                      <button
                        className="p-2 rounded-[0.2rem] bg-[#B57EDC]  border border-[#c7c7c7]  hover:bg-transparent group hover:border-pink-500"
                      ...
                      <button className="p-2 rounded-[0.2rem] bg-[#B57EDC]  border border-[#c7c7c7]  hover:bg-transparent group hover:border-orange-500">
                      ...
                      <button
                        className="p-2 rounded-[0.2rem] bg-[#B57EDC]  border border-[#c7c7c7]  hover:bg-transparent group hover:border-green-500"
                        onClick={() => {
                    ...
                    <div className="gap-x-2 flex ">
                      <Calendar className="text-[#B57EDC ]" size={20} />
